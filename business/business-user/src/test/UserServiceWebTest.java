...
public class UserServiceWebTest {
    private static PlatformLogger logger = PlatformLogger.getLogger(UserServiceWebTest.class);
    ...
    public String add(String name,String password,String sex,String role,String appName){
